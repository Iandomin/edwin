    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="hidden" name="nombre_empleado" value="<?php echo $row['nombre_empleado']  ?>">
                                ...
                                <input type="text" class="form-control mb-3" name="numero_de_trabajador" placeholder="numero_de_trabajador" value="<?php echo $row['numero_de_trabajador']  ?>">
